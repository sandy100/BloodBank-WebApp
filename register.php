...
<!--			    <label for="subject">Username:</label> 
				...
				<!--	<label for="email">Last Donated:</label> 
					...
					<label for="subject">Ward no.</label> 
					<input type="text" class="validate-subject required input_field" onkeypress="return onlyNumbers(event);" name="taluk" id="taluk"/>				               
					<div class="cleaner h10"></div>
				...
				<!--	<label for="subject">Residence Number:</label> 
					...
					<textarea id="text" name="address" id="address" rows="0" cols="0" class="required" placeholder="Enter your detail address with district , place , wardno. , tol name ."></textarea>
					<div class="cleaner h10"></div>
